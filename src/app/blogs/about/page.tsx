  ...
  return (
    <div className="px-4 lg:px-8 py-8">
      ...
      <div className="max-w-4xl mx-auto p-6 lg:p-8 rounded-2xl shadow-2xl bg-green-200 border border-l-transparent border-r-transparent border-[#f8f5f4]">
        ...
        <p className="text-gray-600 mb-4 text-center">
        Over the years, I've honed my skills in tools like Next.js, React, Tailwind CSS, and more, blending design with technology to bring ideas to life. Alongside this, I’ve ventured into entrepreneurship, exploring e-commerce and building engaging projects that resonate with real-world needs.</p>
        <p className="text-gray-600 mb-4 text-center">
