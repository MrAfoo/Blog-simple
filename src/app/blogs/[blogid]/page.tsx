...
import CommentBox from "@/app/_lib/comment";
...
function BlogDetails() {
  ...
  if (!blog) {
    return (
      <div className="justify-center size-full flex pt-40 bg-[#7ff192dd] min-h-screen font-serif text-4xl">
        Blog not found!
      </div>
    );
  }
  ...
  return (
    <div className="bg-green-400 min-h-screen py-6 px-4 md:py-10 md:px-6 font-sans font-semibold">
